      ...
      >
        <div className="flex w-full max-w-lg flex-col gap-4">
          ...
          <pre
            ...
            className="overflow-auto rounded-md border border-white/[0.08] bg-[var(--color-bg-secondary)] p-3 font-mono text-[11px] text-white/80"
          >
            {redactedMessage}
          </pre>
            ...
            <div className="flex flex-col gap-2">
              ...
              {showStack ? (
                <pre
                  ...
                  className="max-h-64 overflow-auto rounded-md border border-white/[0.06] bg-[var(--color-bg-secondary)] p-3 font-mono text-[11px] text-white/60"
                >
                  {stack}
                </pre>
              ) : null}
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex items-center gap-1.5 rounded-md border border-white/[0.08] px-3 py-1.5 text-[11px] text-white/80 hover:bg-white/[0.06]"
            >
            ...
            <button
              ...
              className="rounded-md bg-primary px-3 py-1.5 text-[11px] text-primary-foreground hover:opacity-90"
            >
              Reload window
            </button>
          </div>
