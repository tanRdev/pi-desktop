      ...
      <div className="min-w-0 flex-1">
        {isEditing ? (
          <input
            ...
            className="block w-full select-text rounded border border-[var(--color-border-strong)] bg-[var(--color-bg-primary)] px-1.5 py-0.5 text-[14px] text-[var(--color-text-primary)] outline-none focus:border-[var(--color-accent)]"
          />
        ) : (
          <span
