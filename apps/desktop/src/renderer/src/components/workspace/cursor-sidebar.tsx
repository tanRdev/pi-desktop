    ...
    >
      ...
      <div className="p-3">
        ...
        >
          ...
          <span className="text-[13px] font-medium text-white/90">New Agent</span>
          <span className="ml-auto text-[11px] text-white/30 font-mono">⌘N</span>
        </button>
      </div>
      ...
      <div className="px-2">
        <nav className="space-y-0.5">
          <SidebarItem icon={<SquaresFour className="size-4" />} label="Marketplace" />
        </nav>
      </div>
      ...
      <div className="border-t border-white/[0.03] p-2">
        ...
        <div className="mt-2 flex items-center gap-3 rounded-lg px-3 py-2 hover:bg-white/[0.03] cursor-pointer transition-colors">
          ...
          <div className="flex-1 min-w-0">
            <div className="text-[13px] font-medium text-white/90 truncate">Tanvi</div>
...
function SidebarItem({
  ...
  return (
    ...
    >
      ...
      {shortcut && (
        <span className="ml-auto text-[11px] text-white/30 font-mono">{shortcut}</span>
      )}
    </button>
  );
}
...
function FileTreeItem({
  ...
  return (
    ...
    >
      <span className={cn("text-white/50", active && "text-white/70")}>{icon}</span>
