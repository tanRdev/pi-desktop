...
export function SourceItem({
  ...
  return (
    <button
      type="button"
      className={cn(
        "flex items-center gap-2 border border-[#474747]/20 bg-[var(--color-bg-secondary)] rounded-md px-2.5 py-1.5 text-left",
    ...
    >
      ...
      <span className="min-w-0">
        <span className="block truncate font-medium text-[11px] tracking-tight text-white/82">
          {label}
        </span>
        {detail ? (
