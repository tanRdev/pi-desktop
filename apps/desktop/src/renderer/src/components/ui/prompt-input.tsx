    ...
    <TooltipProvider>
      ...
      >
        <div
          ...
          onClick={handleClick}
          className={cn(
            "border border-border-subtle bg-transparent cursor-text rounded-md p-3 shadow-sm transition-colors hover:border-border focus-within:border-border-hover focus-within:ring-1 focus-within:ring-ring",
