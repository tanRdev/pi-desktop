...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-0 rounded-lg border border-[#2a2a2a] bg-[#141414] p-0 shadow-lg",
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          "absolute right-0 top-0 p-3 opacity-50 transition-all duration-150",
          "hover:opacity-100 hover:bg-[#1a1a1a]",
