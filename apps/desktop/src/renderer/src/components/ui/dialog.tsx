  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed z-50 grid w-full max-w-lg max-h-[calc(100vh-2rem)] overflow-y-auto gap-0 rounded-xl border border-white/[0.08] bg-[var(--color-bg-secondary)] p-0 shadow-[0_24px_64px_rgba(0,0,0,0.55)] outline-none ring-0 focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0 backdrop-blur-xl",
          className,
        )}
        style={{
          left: "50%",
