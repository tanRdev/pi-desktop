...
export function useAppShellController(): AppShellController {
  ...
  const workspaceShellProps: WorkspaceShellProps = React.useMemo(
    () => ({
      ...
      displayAgentStatus,
      runtimeModeLabel,
      providerSnapshots: workspaceShellControls.visibleProviderSnapshots,
      currentModelValue,
      contextUsage,
      isSwitchingModel,
      isPromptVisible,
      ...
      onSend: handleSend,
      onRetryLastUserMessage: handleRetryLastUserMessage,
    ...
    [
      ...
      displayAgentStatus,
      runtimeModeLabel,
      workspaceShellControls.visibleProviderSnapshots,
      currentModelValue,
      contextUsage,
      isSwitchingModel,
      isPromptVisible,
