...
import { connectAgentHostWithRetry } from "./agent-host-connection";
import { createAgentRuntimeHandlers } from "./agent-runtime-handlers";
...
import { createMainWindow, subscribeToFullscreenChanges } from "./main-window";
import { createAndTrackMainWindow } from "./main-window-lifecycle";
import { createOAuthPromptBridge } from "./oauth-prompt-bridge";
...
import { createThreadWorkspaceActions } from "./thread-workspace-actions";
import { createWorkspaceActivationRouter } from "./workspace-activation-router";
import { resolveWorkspaceInspection } from "./workspace-inspection";
import { createWorkspaceRemovalActions } from "./workspace-removal-actions";
